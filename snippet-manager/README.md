...
1. 点击片段卡片上的星标按钮添加或取消收藏
2. 在左侧边栏选择"收藏夹"查看所有收藏的片段
3. 顶部统计栏会显示收藏数量
...
1. 查看包含Markdown语法的提示词时
2. 系统会自动检测并显示"源码/预览"切换按钮
3. 点击"预览"查看渲染后的Markdown效果

### 导入导出

1. 点击左侧边栏的"导入/导出"按钮
2. **导出**：选择JSON或CSV格式导出所有片段
3. **导入**：拖拽或选择JSON文件批量导入片段
...
- [x] 全面的测试套件（20+ 测试用例）
- [x] 完整的文档体系
- [x] **用户认证系统** - JWT token认证，注册/登录功能
- [x] **暗色主题** - 支持亮色/暗色主题切换
- [x] **收藏夹功能** - 快速标记和筛选收藏片段
- [x] **Markdown支持** - 提示词Markdown格式预览
- [x] **导入导出功能** - 支持JSON/CSV格式批量导入导出
- [x] **片段分享** - 多种格式分享和下载单个片段
